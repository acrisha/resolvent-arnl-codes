...
%%
function [y,D1,D2,dy,U0, dU0] = channelMeanVel_FD(Umean,utau,yg,y)
...
% lexi emma discuss!!!
% lexi took this out just no july 14 because pur profiles already loaded in
% do this
...
% do an if sttaenet here if 
% put a statement in the beginning to ensure the Umean has 0 and 0 at both
% the first and last WN grid point .. if not we need to interpolate
