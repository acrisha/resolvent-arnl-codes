...
%%
function [y,D1,D2,dy,U0, dU0] = channelMeanVel_FD_395mfu()
...
load('channel395_moser_loaddata.mat','retau','Umean','utau','yg','y');   %Currently Umean is at cell edges, already normalized by utau
...
%U0= interp1(yg,Umean,y,'spline'); %mean velocity at cell edges (easier for BCs this way)
U0=Umean; %cell edges
Umean=.5*(Umean(2:end)+Umean(1:end-1)); %cell centers
