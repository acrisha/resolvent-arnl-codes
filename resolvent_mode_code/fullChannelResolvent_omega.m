...
function [RIG,y,D1,D2,dy,U0,sqW,isqW] = fullChannelResolvent_omega(Re,kx,kz,omega,N,nsvd,Umean,utau,yg,y)
% Inputs
...
[y,D1,D2,dy,U0,dU0] = channelMeanVel_FD(Umean,utau,yg,y);
