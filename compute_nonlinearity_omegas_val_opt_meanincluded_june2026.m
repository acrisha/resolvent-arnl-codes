...
quickplotcheckflag = 0; % 0 to skip quick plotting check, 1 to plot figure at end
...
Nz = 4; % spanwise
Ny = ny;   % wall normal
nsvd =  4;  % max amount of modes we can keep, Nkeep is number of modes to keep, preferred divisibility by 2
Nkeep = nsvd;
